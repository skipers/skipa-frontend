...
export const MOCK_REEVAL: MockReeval[] = [
  ...
  // 2026 Q1 이력 (과거 — 검토 현황 노출 제외)
  { patentId: 5,  deptId: 2, reviewStatus: 'done', decision: 'KEEP',    decidedAt: '2026-02-14', dueDate: '2026-02-28', isOverdue: false, isCurrent: false },
  { patentId: 7,  deptId: 2, reviewStatus: 'done', decision: 'DISPOSE', decidedAt: '2026-02-10', dueDate: '2026-02-28', isOverdue: false, isCurrent: false },
  // 2025 Q4 이력 (과거 — 검토 현황 노출 제외)
  { patentId: 4,  deptId: 2, reviewStatus: 'done', decision: 'KEEP',    decidedAt: '2025-11-20', dueDate: '2025-11-30', isOverdue: false, isCurrent: false },
  { patentId: 6,  deptId: 2, reviewStatus: 'done', decision: 'DISPOSE', decidedAt: '2025-11-15', dueDate: '2025-11-30', isOverdue: false, isCurrent: false },
...
export const MOCK_SIMILAR_PATENTS: MockSimilarPatent[] = [
  { id: 1, similarityScore: 92, applicationNumber: 'KR-2020-0156834', title: 'CNN 기반 이미지 품질 자동 분류 시스템', applicant: 'Samsung Electronics Co., Ltd.', applicationDate: '2020-08-15' },
  { id: 2, similarityScore: 87, applicationNumber: 'US-2021-0234567', title: 'Deep Learning Model for Industrial Defect Detection', applicant: 'LG Electronics Inc.', applicationDate: '2021-02-22' },
  { id: 3, similarityScore: 81, applicationNumber: 'EP-2022-0078901', title: 'AI-Based Quality Control System for Manufacturing Processes', applicant: 'Hyundai Motor Company', applicationDate: '2022-04-10' },
  { id: 4, similarityScore: 74, applicationNumber: 'JP-2021-0198765', title: '深層学習を利用した製造工程最適化システム及びその方法', applicant: 'Sony Corporation', applicationDate: '2021-07-30' },
  { id: 5, similarityScore: 68, applicationNumber: 'CN-2023-0034567', title: '基于机器学习的工业质量智能检测方法', applicant: 'Huawei Technologies Co., Ltd.', applicationDate: '2023-01-18' },
  { id: 6, similarityScore: 61, applicationNumber: 'KR-2022-0089012', title: '강화학습 기반 자동화 공정 제어 방법 및 시스템', applicant: 'SK Hynix Inc.', applicationDate: '2022-09-05' },
]
