...
export const MOCK_SIMILAR_PATENTS: MockSimilarPatent[] = [
  ...
  },
  {
    ...
    desc: '소멸된 특허이나 네트워크 트래픽 모니터링 및 품질 관리 영역에서 기술적 겹침이 확인됩니다. 선행기술로서의 영향을 검토할 필요가 있습니다.',
    detail: '기술적으로 겹치는 부분: 두 기술 모두 네트워크 트래픽 모니터링 및 품질 관리 메커니즘을 포함합니다.\n기술적 차이: 대상 특허는 메시지 지향 미들웨어의 병목 구간 모니터링에 집중하고, 비교 특허는 통신 시스템 전반의 네트워크 품질 관리에 중점을 둡니다.\n청구범위 관점: 비교 특허는 네트워크 품질 측정 지표와 제어 방법을 포괄하는 넓은 청구범위를 보유합니다.\n유지 판단 시사점: 소멸된 특허이나 기술 겹침 영역이 존재하므로 선행기술로서의 영향을 검토할 필요가 있습니다.',
  },
  {
